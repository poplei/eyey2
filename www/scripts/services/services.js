    ...
    this.getAllBooks = function(callback) {
        ...
        db.transaction(
            function(tx) {
                ...
                tx.executeSql("INSERT OR REPLACE INTO books (id, title, description, lang) VALUES (1,'Book title 1', 'description 1', 'cn')");
                ...
                tx.executeSql("INSERT OR REPLACE INTO books (id, title, description, lang) VALUES (4,'Book title 4', 'description 4', 'cn')");
...
angular.module('eApp.services', [])
    ...
    .factory('ArticleService', function() {
        ...
        var article = [
            { id: 0, title: 'Article 1', description: 'Description article 1' },
            { id: 1, title: 'Article 2', description: 'Description article 2' },
            { id: 2, title: 'Article 3', description: 'Description article 3' }
        ];
